    ...
    <div class="container">
        <div class="row">                
            ...
            <div class="col-md-6">
                ...
                <div class="alert alert-danger">
                    <?php echo htmlspecialchars( $errorR, ENT_COMPAT, 'UTF-8', FALSE ); ?>
                ...
                <form id="register-form-wrap" action="/register" class="register" method="post">
                    <h2>Criar conta</h2>
                    <p class="form-row form-row-first">
                        <label for="login">Nome de Usuário<span class="required">*</span>
                        </label>
                    ...
                    <p class="form-row">
                        <input type="submit" value="Criar Conta" name="submit" class="button">
                    </p>
