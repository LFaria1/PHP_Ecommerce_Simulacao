                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="/admin/users/<?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/changepassword" class="btn btn-danger btn-xs"><i class="fa fa-unlock"></i> Alterar Senha</a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
